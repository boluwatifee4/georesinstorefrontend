                    ...
                    >
                      <div class="grid grid-cols-12 gap-4 items-end">
                        ...
                        <div class="col-span-3 md:col-span-2">
                          ...
                          >
                          <div
                            class="px-3 py-2 bg-gray-100 border border-gray-300 rounded-md text-gray-900 font-medium"
                          >
                            {{
                              getItemAmount($index)
              ...
              <div class="bg-gray-50 rounded-lg p-6 space-y-3">
                <div class="flex justify-between text-gray-700">
                  ...
                  <span class="font-medium">{{
                    subtotal() | currency: 'NGN' : 'symbol' : '1.2-2'
                  }}</span>
                </div>
                @if (deliveryCost() > 0) {
                  <div class="flex justify-between text-gray-700">
                    ...
                    <span class="font-medium">{{
                      deliveryCost() | currency: 'NGN' : 'symbol' : '1.2-2'
                    }}</span>
                  </div>
                }
                <div
                ...
                >
                  <span>Total:</span>
                  <span>{{
                    total() | currency: 'NGN' : 'symbol' : '1.2-2'
                  }}</span>
                </div>
              </div>
          ...
          <div class="bg-white rounded-xl shadow-sm border">
            ...
            <div class="p-6">
              <div #invoicePreview class="invoice-preview-container">
                <div
                  class="invoice-document bg-white"
                  style="width: 21cm; min-height: 29.7cm; margin: 0 auto; padding: 2cm; box-shadow: 0 0 10px rgba(0,0,0,0.1);"
                >
                  <!-- Header -->
                    ...
                    <div class="invoice-meta text-right">
                      ...
                      <div class="text-sm space-y-1">
                        <div>
                          ...
                          {{
                            invoiceForm.get('invoiceNumber')?.value || 'Not Set'
                          }}
                        </div>
                        <div>
                          <span class="font-medium">Date:</span>
                          {{ formatDate(invoiceForm.get('date')?.value || '') }}
                        </div>
                        <div>
                          <span class="font-medium">Due Date:</span>
                          {{
                            formatDate(invoiceForm.get('dueDate')?.value || '')
                          }}
                        </div>
                      </div>
                    </div>
                    ...
                    <table class="w-full border-collapse">
                      <thead>
                        <tr class="border-b-2 border-gray-300">
                          <th
                            class="text-left py-3 font-semibold text-gray-900"
                          >
                            Description
                          </th>
                          <th
                            class="text-center py-3 font-semibold text-gray-900 w-20"
                          >
                            Qty
                          </th>
                          <th
                            class="text-right py-3 font-semibold text-gray-900 w-24"
                          >
                            Price
                          </th>
                          <th
                            class="text-right py-3 font-semibold text-gray-900 w-28"
                          >
                            Amount
                          </th>
                        </tr>
                      ...
                      <tbody>
                        @for (item of items.controls; track $index) {
                          <tr class="border-b border-gray-200">
                            ...
                            <td
                              class="py-3 text-right font-medium text-gray-900"
                            >
                              {{
                                getItemAmount($index)
                                  | currency: 'NGN' : 'symbol' : '1.2-2'
                  ...
                  <div class="flex justify-end mb-8">
                    <div class="w-80">
                      <div class="space-y-2">
                        ...
                        <div
                          class="flex justify-between py-3 border-t-2 border-gray-300"
                        >
                  ...
                  <!-- Footer -->
                  <div
                    class="mt-12 pt-6 border-t border-gray-200 text-center text-sm text-gray-600"
                  >
